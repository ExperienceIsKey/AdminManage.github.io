...
function renderForm($sno, $name, $sdesp, $ldesp, $error)
...
renderForm($sno, $name, $sdesp, $ldesp, $error);
...
$update = "UPDATE pages SET name='$name', sdesp = '$sdesp', ldesp='$ldesp' WHERE sno='$sno'";
...
$select = "SELECT * FROM pages WHERE sno=$sno";
...
renderForm($sno, $name, $sdesp, $ldesp, '');
